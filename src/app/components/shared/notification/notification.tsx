...
const Notification = React.memo(({ classname }: NotificationProps) => {
    const dispatch = useAppDispatch();

    // actions from redux
    //для индикаторов
    const { addInfoForCommonRequest, addInfoForCommonError } =
        indicatorsNotifications;

    const { commonForRequest, commonForError } = useAppSelector(
    ...
    return (
        <Portal>
            <div
                className={classNames(`${cls.notification}`, mod, [classname])}
            >
                <div className={cls.relative}>
                    ...
                    <div className={cls.coverNotification}>
                        <AttentionSvg className={cls.attentionSvg} />
